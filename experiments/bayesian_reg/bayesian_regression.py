...
if __name__ == "__main__":
  ...
  traces, default_trace, metadata = sample_many_traces(sampler_, PRNGKey(0), 10000, True, max_num_variables=100, max_traces_for_default_trace=10000)
...
#   serialize_traces(traces[-1000:], "experiments/bayesian_regression/data/test_1MM.pkl")
  serialize_traces(metadata, "experiments/bayesian_regression/data/metadata.pkl")
